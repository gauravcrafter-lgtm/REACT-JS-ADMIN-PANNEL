...
//   // Moved out of hardcoded literals into env vars — same pattern as the
//   // rest of the app (AgencyLedger, Flights, Depositrequest). Real
//   // credentials/URLs should never sit directly in source code.
...
//       setReports(arr);
//     } catch (err) {
//       console.error("Gateway report fetch failed:", err);
//       setError("Failed to fetch data. Please try again.");
//     } finally {
//       setLoading(false);
//     }
